...
// const steps = [
//   // { name: "Pending", description: "by Mon, 15 Jul", value: "PENDING" },
//   { name: "Order Placed", description: "on Thu, 11 Jul", value: "PLACED" },
//   {
//     name: "Packed",
...
// const currentStep = 2; // adjust this dynamically if needed
        ...
        return (
          <div key={index} className="flex px-4">
            <div className="flex flex-col items-center">
              ...
              >
                {isActive ? <CheckCircleIcon /> : <FiberManualRecordIcon />}
              </Box>

              {index < statusStep.length - 1 && (
                <div
                  className={`border h-20 w-[2px] ${
                    isActive ? "bg-primary-color" : "bg-gray-300"
                  }`}
                />
              )}
            </div>
            ...
            <div className="ml-2 w-full">
              <div
                className={`${
                  ...
                  orderStatus === "CANCELLED" && isCurrent
                    ? "bg-red-500 text-white"
                    : ""
                } w-full`}
              >
