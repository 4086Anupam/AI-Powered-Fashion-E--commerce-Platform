...
import com.hello.Exception.SellerException;
...
//        authService.sentLoginOtp(req.getEmail()); // this should return the token
//
...
//        }
        ...
        AuthResponse authResponse=authService.signing1(req);
    ...
    public ResponseEntity<Seller> createSeller(
        ...
        String subject = "Stylence Bazaar Email Verification Code";
        String text = "Welcome to Stylence Bazaar, verify your account using this link ";
//        String frontend_url = "http://localhost:3000/verify-seller/";
//
//        emailService.sendVrificationOtpEmail(seller.getEmail(), verificationCode.getOtp(),
//                subject, text + frontend_url);
        String frontend_url = "http://localhost:3000/verify-seller/";
        emailService.sendVrificationOtpEmail(
                seller.getEmail(),
