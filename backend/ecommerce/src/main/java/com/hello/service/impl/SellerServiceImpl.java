...
//        return null;
    ...
    public Seller createSeller(Seller seller) throws Exception {
        ...
        if(sellerExist!=null){
            throw new Exception("Seller aqlready exist ... used different email ");
        }
    ...
    public Seller verifyEmail(String email, String otp) throws Exception {
        ...
        seller.setAccountStatus(AccountStatus.ACTIVE); // ✅ activate account

//        verificationCodeRepository.deleteByEmail(email); // ✅ remove used OTP
